...
// const ClapContainer = (props) => {
//   const { children, setRef, ...restProps } = props;
...
const Usage = () => {
  const { clapState, updateClapState, toggleProps, counterProps } =
    useClapState();
